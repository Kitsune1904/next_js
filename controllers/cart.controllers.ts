...
import {CustomRequest, ICart, IOrder, TProduct} from "../models/models";
 ...
 * @param res
 */
export const addProduct = (req: CustomRequest, res: Response): void => {
 ...
 * @param res
 */
export const deleteProduct = (req: CustomRequest, res: Response): void => {
 ...
 * @param res
 */
export const getOrder = (req: CustomRequest, res: Response): void => {
    const userId: number = Number(req.userId);
